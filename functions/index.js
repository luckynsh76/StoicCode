...
exports.sendDailyStoicWisdom = functions.pubsub.schedule("every day 08:00").timeZone("UTC").onRun(async (context) => {
    try {
        ...
        console.log("Daily Stoic Wisdom sent:", randomQuote);
        return null;
    } catch (error) {
        console.error("Error sending Stoic Wisdom:", error);
        return null;
    }
});